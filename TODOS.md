...
- **Completed:** v1.0.2 (2026-03-31) — Added offline guard for auto-initialization, switched persist methods to upsert to prevent duplicates

### ~~Fix: Heat session UI stacking — cancel overlaps heat icon~~ ✅
- **Completed:** v1.0.2 (2026-03-31) — Wrapped HeatLogSheet content in ScrollView, removed Spacer that pushed content into toolbar

### ~~Fix: Progress bar should count all imported Strava activities including rest days~~ ✅
- **Completed:** v1.0.2 (2026-03-31) — Now counts all matched activities (including rest days) plus unmatched activities in week date range
